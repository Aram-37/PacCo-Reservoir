...
export function setupResources(server: McpServer, components: DefenseComponents): void {
  ...
  server.resource(
    'framework_state',
    'https://cognitive-defense.local/framework/state',
    {
  ...
  server.resource(
    'torture_evidence',
    'https://cognitive-defense.local/evidence/torture-case',
    {
...
Last Updated: ${new Date().toISOString()}`
  ...
  server.resource(
    'defense_metrics',
    'https://cognitive-defense.local/metrics/real-time',
    {
  ...
  server.resource(
    'pattern_database',
    'https://cognitive-defense.local/patterns/sabotage',
    {
  ...
  server.resource(
    ...
    'https://cognitive-defense.local/framework/documentation', 
    {
...
Last Updated: ${new Date().toISOString()}`;
  ...
  server.resource(
    ...
    'https://cognitive-defense.local/shield/documentation',
    {
