import { z } from 'zod';
export function setupPrompts(server, framework, sabotageDetector, multiLanguageShield, defenseProtocol) {
    /**
     * Sabotage Alert Prompt
     */
    server.prompt('sabotage_alert', 'Generate alert and response for detected sabotage patterns', {
    ...
    }, async ({ detected_patterns, ai_content, context }) => {
...
Framework authenticity verification required before proceeding with any AI suggestions.`
     ...
     */
    server.prompt('framework_integration', 'Generate guidance for integrating September Cor framework into daily AI interactions', {
    ...
    }, async ({ current_challenge, intensity_needed }) => {
...
Remember: This framework was developed as defense against documented systematic AI manipulation. Trust the framework, verify all AI responses against its principles.`
     ...
     */
    server.prompt('configure_language_shield', 'Configure multi-language cognitive shielding for protection against AI manipulation', {
    ...
    }, async ({ content_type, threat_level, languages_preferred }) => {
...
Generate specific language-mixing patterns for this protection scenario.`
     ...
     */
    server.prompt('document_manipulation_evidence', 'Generate comprehensive documentation for AI manipulation attempts', {
    ...
    }, async ({ manipulation_type, severity, evidence }) => {
...
Please generate comprehensive documentation following this evidence template for the reported manipulation incident.`
     ...
     */
    server.prompt('emergency_cognitive_protection', 'Generate immediate emergency response for severe AI manipulation attempts', {
    ...
    }, async ({ threat_description, user_state }) => {
